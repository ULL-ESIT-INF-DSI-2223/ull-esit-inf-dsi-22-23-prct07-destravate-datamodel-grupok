...
describe("ColeccionReto", () => {
  ...
  it("should modify the name of a challenge", () => {
    ...
    expect(coleccionReto.getReto(reto1.getID()).getNombre()).to.be.eql(
      nuevoNombre
    );
  });
  ...
  it("should modify the activity type of a challenge", () => {
    ...
    expect(coleccionReto.getReto(reto1.getID()).getTipoActividad()).to.be.eql(
      nuevaActividad
    );
  });
  ...
  it("should throw an error if the new name of a challenge already exists", () => {
    ...
    expect(() => coleccionReto.modificarNombre(reto1, nuevoNombre)).to.throw(
      Error
    );
  });
  ...
  it("should print an error if the challenge does not exist", () => {
    ...
    const nuevoNombre = "patata";
    expect(() => coleccionReto.modificarNombre(reto, nuevoNombre)).to.throw(
      Error
    );
  });
