...
describe("ColeccionRuta", () => {
  ...
  it("should modify the name of a route", () => {
    ...
    expect(coleccionRuta.getRuta(ruta1.getID()).getNombre()).to.be.eql(
      "Ruta 1 modificado"
    );
  });
  ...
  it("should modify the coordinates of a route", () => {
    ...
    expect(
      coleccionRuta.getRuta(ruta1.getID()).getCoordenadasInicio()
    ).to.be.eql(coordenadas2);
    expect(coleccionRuta.getRuta(ruta1.getID()).getCoordenadasFin()).to.be.eql(
      coordenadas2
    );
  });
  ...
  it("should modify the activity of a route", () => {
    ...
    expect(coleccionRuta.getRuta(ruta1.getID()).getTipoActividad()).to.be.eql(
      Actividad.ciclismo
    );
  });
  ...
  it("should modify the difficulty of a route", () => {
    ...
    expect(coleccionRuta.getRuta(ruta1.getID()).getDificultad()).to.be.eql(
      Dificultad.dificil
    );
  });

  it("should return the names of the routes", () => {
    expect(coleccionRuta.getNombreRutas()).to.be.eql([
      "Ruta 1 modificado",
      "Ruta 2",
      "Ruta 3",
    ]);
  ...
  it("should throw an error if the route does not exist", () => {
    ...
    expect(() =>
      coleccionRuta.modificarDificultadRuta(ruta4, Dificultad.dificil)
    ).to.throw("La ruta que deseas modificar no existe.");
  });
  ...
  it("should throw an error if the route does exist", () => {
    ...
    expect(() =>
      coleccionRuta.modificarTipoActividadRuta(ruta4, Actividad.ciclismo)
    ).to.throw("La ruta que deseas modificar no existe.");
  });
  ...
  it("should throw an error if the route does not exist", () => {
    ...
    expect(() => coleccionRuta.modificarDesnivelRuta(ruta4, 100)).to.throw(
      "La ruta que deseas modificar no existe."
    );
  });
  ...
  it("should throw an error if the route does not exist", () => {
    ...
    expect(() => coleccionRuta.modificarLongitudRuta(ruta4, 100)).to.throw(
      "La ruta que deseas modificar no existe."
    );
  });
  ...
  it("should throw an error if the route does not exist", () => {
    ...
    expect(() =>
      coleccionRuta.modificarCoordenadasRuta(ruta4, coordenadas, coordenadas)
    ).to.throw("La ruta que deseas modificar no existe.");
  });
  ...
  it("should throw an error if the route does not exist", () => {
    ...
    expect(() =>
      coleccionRuta.modificarNombreRuta(ruta4, "Ruta 4 modificado")
    ).to.throw("La ruta que deseas modificar no existe.");
  });
  ...
  it("should throw an error if the route does not exist", () => {
    ...
    expect(() => coleccionRuta.eliminar(ruta4)).to.throw(
      "La ruta que deseas eliminar no existe."
    );
  });

  it("should throw an error if the route does exist", () => {
    expect(() => coleccionRuta.insertar(ruta1)).to.throw(
      "La ruta que deseas insertar ya existe."
    );
  });

  it("should throw an error if the route does not exist", () => {
    expect(() => coleccionRuta.getRuta(4)).to.throw(
      "La ruta que deseas obtener no existe."
    );
  });

  it("should throw an error if the route does exist", () => {
    expect(() => coleccionRuta.addRuta(ruta1)).to.throw(
      "La ruta que deseas insertar ya existe."
    );
  });
